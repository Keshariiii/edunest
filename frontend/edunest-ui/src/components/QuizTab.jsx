    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full max-w-5xl mx-auto">
      {!quizData ? (
        <div className="bg-white dark:bg-[#121212] p-8 md:p-10 border border-gray-200 dark:border-[#262626] rounded-xl shadow-2xl relative overflow-hidden">
          ...
          <button onClick={handleGenerateQuiz} disabled={isQuizGenerating} className={`w-full py-4 rounded-xl font-bold text-sm transition-all shadow-sm bg-gray-900 dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-100 disabled:opacity-50`}>
